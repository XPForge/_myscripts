...
export default function DiscoveryPage({ onRestart }: { onRestart: () => void }) {
  ...
  const handleSignOut = async () => { await signOut().catch(() => undefined); clearDiscoveryIdentity(); window.location.href = "/"; };
