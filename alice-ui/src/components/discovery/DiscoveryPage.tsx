...
export default function DiscoveryPage({ onRestart }: { onRestart: () => void }) {
  ...
  const [modal, setModal] = useState<"transcript" | "placeholder" | "delete" | "reset-profile" | "review" | "privacy" | null>(null); const [placeholder, setPlaceholder] = useState(""); const [mobileRail, setMobileRail] = useState<"left" | "right" | null>(null);
