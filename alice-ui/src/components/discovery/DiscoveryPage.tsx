...
import { Bell, Check, ChevronDown, Compass, Copy, Download, FileText, Lightbulb, Menu, Mic, Moon, Paperclip, Pause, Play, RefreshCcw, Send, ShieldCheck, Sparkles, Speaker, Square, Sun, Trash2, Volume2, X, Zap } from "lucide-react";
