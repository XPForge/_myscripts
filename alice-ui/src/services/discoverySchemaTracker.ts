...
// Broadened from the original literal-phrase-only lists, which required
// near-exact wording and left most real (non-scripted) conversations stuck
// at 0% readiness even when a participant had clearly covered the topic in
// their own words. Still a heuristic, not NLP -- just less brittle now.
