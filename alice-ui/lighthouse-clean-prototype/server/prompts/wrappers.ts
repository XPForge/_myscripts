...
export function getWrapperPrompt(context: DiscoveryContext) {
  switch (context) {
    ...
    case "general":
    default:
      return "This interview is for general Human Capability discovery. The goal is to understand the participant deeply and accurately without narrowing the conversation to a single institutional context.";
  }
}
